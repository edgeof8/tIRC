...
from dcc_transfer import DCCSendTransfer, DCCTransferStatus # Assuming DCCTransferType is not directly used here
from dcc_protocol import format_dcc_send_ctcp, format_dcc_resume_ctcp
