...
from dcc_transfer import DCCSendTransfer, DCCReceiveTransfer, DCCTransferStatus

if TYPE_CHECKING:
    from dcc_manager import DCCManager # To avoid circular import for type hinting
    # dcc_transfer types already imported above for runtime, but good for explicitness in TYPE_CHECKING
    # from dcc_transfer import DCCTransfer, DCCSendTransfer, DCCReceiveTransfer, DCCTransferStatus
